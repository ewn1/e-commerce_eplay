    ...
    <>
      ...
      <Section title="Sobre o jogo" background="black">
        <p>
          ...
          poções, domine o lançamento de feitiços, aprimore talentos e torn-se o
          bruxo que deseja ser. Experimente Hogwarts da década de 1800. Seu
      ...
      <Section title="Mais detalhes" background="gray">
        <p>
          ...
          <b>Editora:</b> Portkey Games, subsidiária da Warner Bros. Games
      ...
      <Gallery name="jogo teste" defaultCover={metroid4} />
    </>
  )
}
